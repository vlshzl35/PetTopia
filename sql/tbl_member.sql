...
values  (1, 'c@c', 'M', '최창욱', '$2a$10$PG/EMdeDoRbQiEDVaxh2yeCZHVtnvYs1URfg1j77kMPXV40rFDFlq', 'c', null, '1992-02-24', '2024-08-11', 'c', '', 'NONE'),
        (2, 'c1@c', 'M', '박태준', '$2a$10$zo/DtEmUpsjgWAhyi0EmAuZymJsSYHQipQQ4Go0uC/9vvO3nydZIq', '1', null, '1992-02-02', '2024-08-11', 'c', '', 'NONE'),
        (3, 'c2@c', 'F', '홍지민', '$2a$10$m4Z/hst2kLWUkPgrzZVWe.vwaM2vXlF5EJ647Qmg/PGQKZKyvUwLO', '1', null, '0123-12-03', '2024-08-11', 'c', '', 'NONE'),
        (4, 'c3@c', 'F', '양희윤', '$2a$10$Pr5CqFuFaeu1TW9r0jgl7OMvoiZSzdOE7d3.GxLvrDkPpbWJGTBoK', 'c', null, '1223-02-02', '2024-08-11', 'c', '', 'NONE'),
        (5, 'c4@c', 'F', '이영우', '$2a$10$jmtvwsHKcQgWe2X1uho23OhQM.dd0J54LMHzLKq0lom0e4bGpcdWi', 'c', null, '1232-02-02', '2024-08-11', 'c', '', 'NONE'),
