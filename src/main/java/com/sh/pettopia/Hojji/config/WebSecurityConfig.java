...
public class WebSecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring().requestMatchers("css/**", "js/**",  "scss/**", "images/**", "fonts/**", "json/**", "ocr/**"); // 이 경로로 시작하는 것들은 보안 검사를 하지 말라는 의미
    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            registry.requestMatchers("/", "/index.html","/ocrUpload", "/petsitter/petsittingmain", "petsitter/list", "petsitterfinder/careregistrationlist", "/enterprise/location", "community/posts").permitAll() // 누구나 허용
